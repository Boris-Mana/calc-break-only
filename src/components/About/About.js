    ...
    return (
        <section className="about">
            ...
            <ul className="about__title">Для кого:
                ...
                <li className='about__text'>
                    <strong>&#8226; </strong>представители корпоративных заказчиков и органов власти, в обязанность которых входит контроль качества результатов определения стоимости объектов недвижимости;
                </li>                
            </ul>
        </section>
    )
